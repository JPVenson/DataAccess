...
namespace JPB.DataAccess.AdoWrapper
{
	...
	public class ThreadConnection
	{
		...
		{
			Transactions = new Queue<KeyValuePair<object, IDbTransaction>>();
			LockRoot = new object();
		}

		internal Queue<KeyValuePair<object, IDbTransaction>> Transactions { get; private set; }
		...
		public IDbTransaction Transaction
		{
			...
			set
			{
				...
				else if (value != null)
				{
					...
					new KeyValuePair<object, IDbTransaction>(new object(), value));
				}
			}
		}
