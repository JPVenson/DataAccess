...
//		{
//			var images = TestInit(null, new[] { new LocalDbUniqueConstraint<Image>("BookId is Unique", s => ((Image)s).IdBook), }, null);
...
//			Assert.That(() =>
//			{
//				images.Constraints.Unique.Add(new LocalDbUniqueConstraint<Image>("BookId is Unique", s => ((Image)s).IdBook));
//			}, Throws.Exception.TypeOf<InvalidOperationException>());
//		}
...
//			{
//				new LocalDbDefaultConstraint<Image>("DefaultConstraint", 666, (source, constVal) => (source as Image).IdBook = (int)constVal),
//			});
...
//				new LocalDbDefaultConstraint<Image, int>("DefaultConstraint", 666, (source, constVal) => (source as Image).IdBook = (int)constVal));
//			}, Throws.Exception.TypeOf<InvalidOperationException>());
//		}
