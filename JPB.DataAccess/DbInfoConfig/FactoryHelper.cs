...
namespace JPB.DataAccess.DbInfoConfig
{
	...
	public class FactoryHelper
	{
		...
		//		var isForginKey = attributes.First(e => e.Attribute is ForeignKeyAttribute)?.Attribute;
		...
		//				new CodeFieldReferenceExpression(new CodeVariableReferenceExpression("System.DBNull"), nameof(DBNull.Value)));
		...
		//					new CodeTypeReferenceExpression(typeof(NonObservableDbCollection<>)
		...
		//					nameof(XmlDataRecord.TryParse),
		//					new CodeCastExpression(typeof(string), uncastLocalVariableRef),
		//					typeofProperty,
		//					new CodePrimitiveExpression(true));

		//				var setProps = new CodeMethodInvokeExpression(getClassInfo, 
		//					nameof(DbAccessLayerHelper.SetPropertysViaReflection), tryParse,
		...
		//			}
		//		}
		//		else if (isForginKey != null)
		//		{
		//			var castExp = new CodeCastExpression(
		//				new CodeTypeReference(typeof(EagarDataRecord[]), 
		//					CodeTypeReferenceOptions.GenericTypeParameter),
		//				codeIndexerExpression);

		//			var selectionExp = new CodeMethodInvokeExpression(
		//				new CodeTypeOfExpression(typeof(Enumerable)), nameof(Enumerable.Select),
		//				castExp,
		//				new CodeSnippetExpression(
		//					$"reader => JPB.DataAccess.{nameof(DbAccessLayerHelper)}.{nameof(DbAccessLayerHelper.SetPropertysViaReflection)}"));
		//		}
		//		else
		//		{
		...
		//				var converterInstanceCall = new CodeMethodInvokeExpression(converterCall, nameof(IValueConverter.Convert),
		//					new CodeVariableReferenceExpression(variableName),
