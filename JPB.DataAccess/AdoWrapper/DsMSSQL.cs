...
namespace JPB.DataAccess.AdoWrapper
{
    internal class DsMSSQL : IDatabaseStrategy
    {
        ...
        private readonly string _conn_str = string.Empty;

        public DsMSSQL(string strServer, string strDatabase)
        {
            _conn_str = string.Format(TEMPLATE_MSSQL_TRUSTED, strServer.Trim(), strDatabase.Trim());
        }

        public DsMSSQL(string strServer, string strDatabase, string strLogin, string strPassword)
        {
        ...
        public DsMSSQL(string strConnStr)
        {
            _conn_str = strConnStr;
        }
        ...
        {
            return new SqlConnection(_conn_str);
        }
