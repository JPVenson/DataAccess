...
namespace JPB.DataAccess.Manager
{
	public partial class DbAccessLayer
	{
		...
		/// <typeparam name="T"></typeparam>
		/// <returns></returns>
		public static T[] RunSelect<T>(IDatabase database, string query, IEnumerable<IQueryParameter> paramenter, bool egarLoading)
		{
		...
		{
			var mars = Database.EnumerateMarsDataRecords(bulk, this.LoadCompleteResultBeforeMapping);
